...
export const LeagueSelector: React.FC<LeagueSelectorProps> = ({
  ...
  const leagues = [
    { id: 'NBA' as const, name: 'NBA', color: 'bg-blue-600 hover:bg-blue-700' },
    { id: 'NFL' as const, name: 'NFL', color: 'bg-green-600 hover:bg-green-700' },
    { id: 'MLB' as const, name: 'MLB', color: 'bg-purple-600 hover:bg-purple-700' },
  ];
