...
from matchupscore import def_rank
...
norm['Display Name'] = norm['Display Name']
...
def nba_over(num, timeframe):
    ...
    data_rows_goblin = []
    headers = [
        'Name', 'Position', 'Team', 'AgainstTeam', 'Stat', 'Line', 'Odds', 'H2HArray', 'L5Array',
        'l7_mr', 'l15_mr', 'l30_mr',
...
print(teamdf)
print(norm)
#nba_over(0, "since-2024-2025-season")
nba_over(0, "since-2025-2026-season")
